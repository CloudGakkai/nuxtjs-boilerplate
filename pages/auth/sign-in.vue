    ...
    <div>
      ...
      >
        ...
        <p class="text-sm text-gray-500 mb-[30px] dark:text-gray-dark-500">
          Masuk untuk mulai menggungah dan membagikan berkas.
        </p>
        <div>
          <label for="email">
            <p
          ...
          <div class="form-control mb-[20px]">
            ...
            >
              <input
                class="input flex-1 bg-transparent text-gray-300 focus:outline-none dark:text-gray-dark-300"
                type="text"
                placeholder="Email"
                name="email"
              />
        ...
        >
          Masuk</button
        ><a
          class="text-right text-xs block text-[#8083A3] mb-[20px]"
          href="/auth/forgot-password"
          >Lupa Kata Sandi?</a
        >
        <p
          class="text-sm text-gray-1100 dark:text-gray-dark-1100 text-center mb-5"
        >
          Atau masuk dengan
        </p>
        <div class="flex items-center gap-x-2 justify-between mb-[20px]">
          <a
            class="flex items-center justify-center border rounded-lg gap-x-[10px] border-[#E8EDF2] p-[3px] py-[14px] sm:min-w-[170px]"
            href="#"
          >
            <img
              src="/assets/images/icons/icon-google.svg"
              alt="google icon"
            /><span class="text-gray-1100 text-xs dark:text-gray-dark-1100"
              >Google</span
            ></a
          ><a
            class="flex items-center justify-center border rounded-lg gap-x-[10px] border-[#E8EDF2] p-[3px] py-[14px] sm:min-w-[170px]"
        ...
        <p class="text-sm text-gray-1100 dark:text-gray-dark-1100">
          Belum punya akun?<a class="text-color-brands" href="/auth/sign-up"
            >&nbsp;Buat Sekarang</a
          >
        </p>
      </form>
